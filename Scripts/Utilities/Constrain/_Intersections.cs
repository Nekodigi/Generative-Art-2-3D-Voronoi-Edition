...
public static class _Intersections
{
    ...
    public static bool LineLine(Vector3 l1_p1, Vector3 l1_p2, Vector3 l2_p1, Vector3 l2_p2, bool shouldIncludeEndPoints)
    {
    ...
    //http://thirdpartyninjas.com/blog/2008/10/07/line-segment-intersection/
    public static Vector3 GetLineLineIntersectionPoint(Vector3 l1_p1, Vector3 l1_p2, Vector3 l2_p1, Vector3 l2_p2)
    {
        float denominator = (l2_p2.y - l2_p1.y) * (l1_p2.x - l1_p1.x) - (l2_p2.x - l2_p1.x) * (l1_p2.y - l1_p1.y);

        float u_a = ((l2_p2.x - l2_p1.x) * (l1_p1.y - l2_p1.y) - (l2_p2.y - l2_p1.y) * (l1_p1.x - l2_p1.x)) / denominator;

        Vector3 intersectionPoint = l1_p1 + (l1_p2 - l1_p1) * u_a;
